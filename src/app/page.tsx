    ...
    return (
      <div className="min-h-screen bg-[#0D1B2A] flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-[#9BA3AE] text-sm" style={{ fontFamily: "'DM Sans', sans-serif" }}>Loading...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="flex items-center justify-center min-h-screen px-5 relative z-10">
        <div className="text-center max-w-md w-full animate-fade-in">
          ...
          <div className="flex flex-col gap-3 mb-12">
            ...
            <Link
              href="/auth/login"
              className="w-full py-4 bg-[#111827] border border-[rgba(255,255,255,0.05)] text-[#E8E6E1] text-lg font-semibold rounded-[12px] hover:border-[rgba(255,87,34,0.3)] transition-colors text-center"
              style={{ fontFamily: "'DM Sans', sans-serif" }}
            >
              Sign In
            </Link>
          ...
          <div className="grid grid-cols-1 gap-4">
            <div className="bg-[#111827] border border-[rgba(255,255,255,0.05)] rounded-[12px] p-5 text-left flex items-start gap-4 hover:border-[rgba(255,87,34,0.3)] transition-colors">
              ...
              <div>
                ...
                <p className="text-sm text-[#9BA3AE] leading-relaxed" style={{ fontFamily: "'DM Sans', sans-serif" }}>Pick one team per tournament day. Each team can only be used once.</p>
              </div>
            </div>
            ...
            <div className="bg-[#111827] border border-[rgba(255,255,255,0.05)] rounded-[12px] p-5 text-left flex items-start gap-4 hover:border-[rgba(255,87,34,0.3)] transition-colors">
              ...
              <div>
                ...
                <p className="text-sm text-[#9BA3AE] leading-relaxed" style={{ fontFamily: "'DM Sans', sans-serif" }}>Real-time scores, standings, and elimination updates.</p>
              </div>
            </div>
          </div>
        </div>
