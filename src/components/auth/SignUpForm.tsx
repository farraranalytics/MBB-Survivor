  ...
  if (success) {
    return (
      <div className="min-h-screen bg-[#0D1B2A] flex items-center justify-center px-5">
        <div className="max-w-md w-full bg-[#111118] border border-[rgba(255,255,255,0.05)] rounded-[12px] p-8 text-center animate-bounce-in">
          <div className="mb-6">
            <div className="mx-auto w-16 h-16 bg-[rgba(76,175,80,0.15)] rounded-full flex items-center justify-center mb-4">
      ...
      <div className="max-w-md w-full animate-fade-in">
        ...
        <div className="bg-[#111118] border border-[rgba(255,255,255,0.05)] rounded-[12px] p-6 sm:p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-[#8A8694] text-sm" style={{ fontFamily: "'DM Sans', sans-serif" }}>Join Survive the Dance</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <label htmlFor="displayName" className="block text-sm font-medium text-[#8A8694] mb-2" style={{ fontFamily: "'DM Sans', sans-serif" }}>Display Name</label>
            ...
            <div>
              <label htmlFor="email" className="block text-sm font-medium text-[#8A8694] mb-2" style={{ fontFamily: "'DM Sans', sans-serif" }}>Email</label>
            ...
            <div>
              <label htmlFor="password" className="block text-sm font-medium text-[#8A8694] mb-2" style={{ fontFamily: "'DM Sans', sans-serif" }}>Password</label>
            ...
            <div>
              <label htmlFor="confirmPassword" className="block text-sm font-medium text-[#8A8694] mb-2" style={{ fontFamily: "'DM Sans', sans-serif" }}>Confirm Password</label>
